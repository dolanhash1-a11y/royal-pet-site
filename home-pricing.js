...
const PRICING_ORDER=[
 {key:'complex',title:'Комплекс',price:600,match:s=>/комплекс/i.test(String(s.title||''))},
 {key:'hygiene',title:'Гігієна',price:600,match:s=>/гігієн/i.test(String(s.title||''))},
 {key:'adaptive',title:'Адаптація',price:500,match:s=>/адаптив|адаптац/i.test(String(s.title||''))},
 ...
 {key:'teeth',title:'Гігієна зубів',price:100,match:s=>/зуб/i.test(String(s.title||''))},
 {key:'eyes',title:'Гігієна очей',price:100,match:s=>/оч/i.test(String(s.title||''))}
];
