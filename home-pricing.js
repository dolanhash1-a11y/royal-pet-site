...
const PRICING_ORDER=[
 {title:'Комплекс',match:s=>/комплекс/i.test(String(s.title||''))},
 {title:'Гігієна',match:s=>/гігієн/i.test(String(s.title||''))},
 {title:'Адаптація',match:s=>/адаптив|адаптац/i.test(String(s.title||''))},
 {title:'Вичісування линяючої шерсті шпіца + купання'},
 {title:'Вичісування линяючої шерсті шпіца'},
 {title:'Вичісування ковтунів'},
 {title:'Збривання ковтунів'},
 {title:'Купання до 10 кг'},
 {title:'Гігієна зубів',match:s=>/зуб/i.test(String(s.title||''))},
 {title:'Гігієна очей',match:s=>/оч/i.test(String(s.title||''))}
];
