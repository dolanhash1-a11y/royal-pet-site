...
const GROUPS={
  complex:{title:'Комплекс',text:'Повний комплекс догляду.'},
  hygiene:{title:'Гігієна',text:'Гігієнічні процедури та догляд.'},
  adaptive:{title:'Адаптаційний грумінг',text:'Дбайливий підхід для улюбленців.'},
  additional:{title:'Додаткові послуги',text:'Окремі процедури та доповнення.'}
};
